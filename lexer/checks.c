...
// static int not_double(char *c)
// {
//     if (((c[0] == '|' && c[1] == '|') || (c[0] == '&' && c[1] == '&')) && ((c[3] == '|' && c[4] == '|') || (c[3] == '&' && c[4] == '&') || (c[3] == '|' && c[4] == ' ')))
//         return (1);
// 	if ((c[0] == '|' && c[1] == ' ') && ((c[2] == '|' && c[3] == '|') || (c[2] == '&' && c[3] == '&') || (c[2] == '|' && c[3] == ' ')))
// 		return (1);
// 	if (((c[0] == '>' && c[1] == '>') || (c[0] == '<' && c[1] == '<')) && ((c[3] == '>' && c[4] == '>') || (c[3] == '<' && c[4] == '<') || (c[3] == '>' && c[4] == ' ') || (c[3] == '<' && c[4] == ' ')))
//         return (1);
// 	if (((c[0] == '>' && c[1] == ' ') || (c[0] == '<' && c[1] == ' ')) && ((c[2] == '>' && c[3] == '>') || (c[2] == '<' && c[3] == '<') || (c[2] == '>' && c[3] == ' ')  || (c[2] == '<' && c[3] == ' ')))
// 		return (1);
//     return (0);
// }
